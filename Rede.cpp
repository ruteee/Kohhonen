...
int main(int argc, char* argv[] ){
	...
	//cout << "Numero de colunas: " <<arquivo_entrada->numero_colunas<<endl;
	/*#pragma omp parallel for num_threads(threads_count)
	for(int i = 0; i < arquivo_entrada->numero_linhas; i++){
		for(int j= 0; j< arquivo_entrada->numero_colunas; j++){
			//cout << arquivo_entrada->matriz_de_entradas[i][j]<<endl;
			int myrank = omp_get_thread_num();
			//cout << "Impresso pela thread "<<myrank << " ";
		}
		cout <<endl;
	}*/
	...
	testeDeRede(0, 0, 255, altura, largura, grid_de_neuronios);
...
void treinamento(
    ...
    do{
    	...
    	//cout << "Numero de linhas da entrada " << arquivo_entrada->numero_linhas<<endl;
